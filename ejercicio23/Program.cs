...
namespace ejercicio22
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            AlmacenObjetos<empleado> almacen1 = new AlmacenObjetos<empleado>(4);
            ...
            empleado emp1 = almacen1.GetElemento(2);
    ...
    public class AlmacenObjetos<T>
    {
        ...
        private T [] datosElementos; // Arreglo que guardará los elementos (tipo object para aceptar cualquier cosa)
        ...
        {
            datosElementos = new T [z]; // Creamos el arreglo con el tamaño que nos pidan
        }
    }
